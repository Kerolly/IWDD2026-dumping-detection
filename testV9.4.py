...
# ============================================================================
# CONFIGURATION (V9.4 - + dual bg subtraction / further relaxed gates)
# ============================================================================
...
RECENT_A_SEC   = 0.8
LOOKBACK_A_SEC = 0.8
AREA_JUMP_RATIO = 1.10  # Further lowered
AREA_CV_MIN     = 0.10

# Near-cluster (relaxed)
CLUSTER_RADIUS_BASE = 350  # Further increased
...
# Optical flow
FLOW_MAG_THRESH = 1.0  # Lowered for more subtle motion
FLOW_WIN_SEC = 0.5
...
LONG_HISTORY = 2000
LONG_VAR_THRESH = 16
DF_RATIO_THRESH = 0.3  # For eligible_by_dual_bg
FG_RATIO_THRESH = 0.2  # Lowered for single fg

# Debug
DEBUG_ENABLED = True
DEBUG_SUBDIR_NAME = 'debug_v9_4'

# ============================================================================
# ARGUMENTS
# ============================================================================
def parse_arguments():
    p = argparse.ArgumentParser(description='IWDD v9.4 Inference - + dual bg sub / relaxed gates')
...
def process_single_video(video_path, output_dir, model_garbage, debug=False):
    ...
    for res in results_stream:
        ...
        df_mask = (fg_long > 0) & (fg_short == 0)  # Difference foreground for abandoned
...
def main():
    ...
    print("=== IWDD v9.4 Inference (new/moving + dual bg sub / relaxed) ===")
